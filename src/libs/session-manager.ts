...
/**
 * Creates a new session with the given IP and secure status.
 *
 * @param manager The session manager to use.
 * @param ip The IP address of the client.
 * @param secure Whether the session should be encrypted. If true, the session key will not be sent to the client.
 * @param userPublicKey The public key of the client. If secure is true, this must be provided.
 * @returns An object containing the encrypted data to be sent to the client and the ID of the session.
 *
 * @throws If secure is false and userPublicKey is not provided.
 */
